...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/06/10 10:59:50 by louka             #+#    #+#             */
/*   Updated: 2026/06/10 12:59:54 by louka            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Account::_displayTimestamp(void) 
{
	...
	std::cout << "[" << (now->tm_year + 1900) << std::setfill('0') << std::setw(2) << (now->tm_mon + 1) << std::setfill('0') << std::setw(2) << now->tm_mday << "_" 
